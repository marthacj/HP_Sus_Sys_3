# This file is for testing Llama3-ChatQA-8B model with different prompts, contexts, RAGS.
...
# Model path
model_path = r"C:\Users\martha.calder-jones\OneDrive - University College London\UCL_comp_sci\Sustainable_Systems_3\HP_Sus_Sys_3\models\llama3-chatqa-1.5-8b.Q5_K_M.gguf"
...
while True:
    user_input = input("This is the LLama3-Chat-QA model. Enter\n [1] Benchmark no data\n [2] Benchmark CSV & YAML data \n [3] Prompt Engineered \n [4] RAG\n\n")

    if user_input == '1':
        # ============================================================================================
        # BENCHMARKING FOR LLAMA3-ChatQA-8B MODEL, NO INPUT DATA & ONLY RECOMMENDED PROMPT FOR NO CONTEXT
        # ============================================================================================

        # Define the prompt template: See recommendations for no contxext template on model page: https://huggingface.co/nvidia/Llama3-ChatQA-1.5-70B
        template_str = """
                    System: This is a chat between a user and an artificial intelligence assistant. The assistant gives helpful, detailed, and polite answers 
        ...
        # Construct the PromptTemplate object: Do we want to be using langchain object for this?
        ...
        # See recommendations on model page: https://huggingface.co/nvidia/Llama3-ChatQA-1.5-70B
        template = """System: This is a chat between a user and an artificial intelligence assistant. The assistant gives helpful, detailed, and polite answers 
                    to the user's questions based on the context. The assistant should also indicate when the answer cannot be found in the context.
                    You have been provided with the following context, which includes information about the carbon emissions produced by different remote desktops 
                    in a workstation or pool, and information their compute usage over a period of time:
                    {Context}
