...
# Load yaml file
with open(r'C:\Users\martha.calder-jones\OneDrive - University College London\UCL_comp_sci\Sustainable_Systems2\HP_Sus_Sys_2\manifest\outputs\z2_G4_Sci_Output.yml.yaml', 'r') as f:
...
input = input("Enter 'Benchmark no data', 'Benchmark CSV & YAML data', 'Prompt Engineered', or 'RAG':")

if input.lower() == 'benchmark no data':
    # ============================================================================================
...
elif input.lower() == 'benchmark csv & yaml data':
    # ================================================================================================================
...
elif input.lower() == 'prompt engineered':
    ...
    print("Invalid input. Please enter 'Benchmark', 'Prompt Engineered', or 'RAG', or 'Exit.")